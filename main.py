...
"
        "┌──────────────────────────────
"
        f"│ 💵 <b>Uang</b>        : <code>{escape(str(money))}</code>
"
        f"│ 🪙 <b>Coins</b>       : <code>{escape(str(coins))}</code>
"
        f"│ ⭐ <b>Level</b>       : <code>{escape(str(level))}</code>
"
        f"│ 🚗 <b>Mobil</b>       : <code>{escape(str(cars))}</code>
"
        f"│ 👕 <b>Pakaian</b>     : <code>{escape(str(clothes))}</code>
"
        f"│ 🔧 <b>Tuning</b>      : <code>{escape(str(tuning))}</code>
"
        "└──────────────────────────────
